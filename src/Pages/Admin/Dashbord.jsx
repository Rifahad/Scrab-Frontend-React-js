...
//       <div className="mb-24 grid grid-cols-1 gap-6 xl:grid-cols-3">
...
import DashboardBox from "../../Components/Admin/Dashboard/Box";
...
const Dashbord = () => {
  ...
  const fetchTotalUserCount = async () => {
    try {
      ...
      console.log(response.data.userData,'  total user userData');
      setuserTabledata(response.data.userData)
  ...
  const fetchTotalAgentCount = async () => {
    try {
      ...
      // console.log(response.data.count,'total agent count');
  ...
  const fetchTotalPickupCount = async () => {
    try {
      ...
      console.log(response.data.count,'pick up count');
  ...
  const fetchTotalAgentPickupCount = async () => {
    try {
      ...
      console.log(response.data.count,'agent pickup  count');
  ...
  return (
    <>
      <div className="flex flex-wrap gap-10">
        ...
        <DashboardBox
          icon={BanknotesIcon}
          Name={'Total Pickup Users'}
          count={pickupCount}
          para={'+55% than last week'}
        />
        <DashboardBox
          icon={ChartBarIcon}
          Name={'Total Pickup Company'}
          count={agentPickupCount}
          para={'+55% than last week'}
        />
       </div>
      ...
      <div className="  mt-5 mb-6 grid grid-cols-1 gap-y-12 gap-x-6 md:grid-cols-2 xl:grid-cols-3">
        ...
        <Card className="overflow-hidden xl:col-span-2 border border-blue-gray-100 shadow-sm">
          ...
          >
            <div>
              ...
              >
                <CheckCircleIcon strokeWidth={3} className="h-4 w-4 text-blue-gray-200" />
                <strong>Total </strong> Registered
              </Typography>
            </div>
            <Menu placement="left-start">
              <MenuHandler>
    ...
    {userTabledata.map((user, index) => (
      <tr key={index}>
        <td className="py-3 px-6">
          <div className="flex items-center gap-4">
            {/* Assuming user has an image URL and name */}
            <p>              {user.name}            </p>
